    ...
    main: () => {
        ...
        function testUtilIndex() {
            ...
            const testFindShadowRoot = () => {
                ...
                console.log(parent === null || parent === void 0 ? void 0 : parent.getRootNode().nodeName);
                console.log(child === null || child === void 0 ? void 0 : child.getRootNode().nodeName);
                var shadowRoot = shadowHost === null || shadowHost === void 0 ? void 0 : shadowHost.attachShadow({ mode: 'open' });
                shadowRoot.innerHTML = '<style>div{background:#2bb8aa;}</style>'
                    + '<div class="js-shadowChild">content</div>';
                var shadowChild = shadowRoot.querySelector('.js-shadowChild');
                console.log((shadowChild === null || shadowChild === void 0 ? void 0 : shadowChild.getRootNode()) === shadowRoot);
                console.log((shadowChild === null || shadowChild === void 0 ? void 0 : shadowChild.getRootNode({ composed: false })) === shadowRoot);
                console.log(shadowChild === null || shadowChild === void 0 ? void 0 : shadowChild.getRootNode({ composed: true }).nodeName);
            ...
            const testGetNextElement = () => {
                ...
                const handleResult = (fun, arr, cur, for_next, cycled) => {
                    ...
                    li.textContent = text;
                    result_ul === null || result_ul === void 0 ? void 0 : result_ul.appendChild(li);
                };
                if (result_ul) {
        ...
        function _tryShowJson(desc, jsonStr) {
            try {
                ...
                jsonStr = jsonStr === null || jsonStr === void 0 ? void 0 : jsonStr.replace(/\'/g, '\"');
                try {
                    const json = JSON.parse(jsonStr || '');
                    console.log(`success for ${desc}:`, json);
                }
