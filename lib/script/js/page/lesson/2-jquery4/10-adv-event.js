    ...
    main: () => {
        ...
        function extensionEvenAccordingToBook() {
            ...
            $(document).on('nextPage', function (_, scrollToVisible) {
                ...
                $.get(`/lib/html-clip/${nextPage}.html`, (data) => __awaiter(this, void 0, void 0, function* () {
                    var _a;
                    const jdata = $(data).appendTo('#gallery');
                    if (scrollToVisible) {
                        $(window).scrollTop(((_a = jdata.offset()) === null || _a === void 0 ? void 0 : _a.top) || 0);
        ...
        function testAjax() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                // 	console.log(data);
                // });
                const data = yield $.get('/lib/html-clip/1.html'); //ok
                console.log(data);
            });
        }
        /**
        ...
        function testScrollBarMethod() {
            ...
            function examScroll(evt) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    const resp = yield Guoshi.Misc.sleep(3258);
