...
JscssLoader.getInstance().startEntry({
    ...
    main: function () {
        ...
        $('#henry-next').click(function () {
            var t = $('td:contains(Henry),td:contains(Tragedy)');
