...
JscssLoader.getInstance().startEntry({
    ...
    main: function () {
        ...
        function data() {
            ...
            console.log((_a = jtempLink.get(0)) === null || _a === void 0 ? void 0 : _a.outerHTML); //仍然看不到data-属性
        }
        /**
         * $.inArray方法测试
         */
        ...
        function map() {
            [
                'map()方法,返回值由调用方决定',
                (function () {
                    var rst1 = $('a').map(function (index, ele) {
                        //          console.log(this === ele);      //顺便测试 true
                        return this.id;
                    });
                    var rst2 = ['a', 'b', 'c', 'd'].map(function (ele, idx) {
                        console.log(ele);
                        return ele + (idx * 2);
                    });
                    ...
                    //     return ele.id;
                    // });
                    var rst4 = $.map(['a', 'b', 'c', 'd'], function (ele, idx) {
                        return ele + (idx * 3);
                    });
                    return [
                        rst1,
            ...
            [
                ...
                (function () {
                    var _a = [
                        ...
                        $('.index_demo li'),
                        $('.index_demo div')
                    ], jfoo = _a[0], jlies = _a[1], jdivs = _a[2];
                    return [
                        jfoo.index(),
                        jlies.index(),
                        jlies.first().index(),
        ...
        function Dom_jq() {
            [
                ...
                (function () {
                    var dom = document.getElementById('temp_ul');
                    return [
        ...
        function escape_css_notation() {
            ...
            [
                'css字符转义:',
                (function () {
                    var id = "such id,you'will be mad.or.crazy";
                    var id_1 = "such\ id,you\'will\ be\ mad\.or\.crazy";
                    var escId = "such\\ id\\,you\\'will\\ be\\ mad\\.or\\.crazy";
                    var escId_1 = jq(id);
                    return [
