    ...
    main: function () {
        ...
        function enable_disable_anim_demo() {
            $('div.enable_disable_anim_demo input[type="button"]').click(function () {
                $.fx.off = !$.fx.off;
                console.log("current animation:".concat(!$.fx.off));
            });
        }
        /**
         ...
         */
        function fade_demo() {
            var jcontent = $('pre.content-demo');
            var jbtn1 = $('.fade_demo input[type="button"]:first-child');
            var jbtn2 = jbtn1.next();
            var jbtn3 = jbtn2.next();
            var jbtn4 = jbtn3.next();
            function showProps() {
                var jele = $(this);
