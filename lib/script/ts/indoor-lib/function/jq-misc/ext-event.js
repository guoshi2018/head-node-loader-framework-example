(function ($) {
            ...
            $(this).on('scroll.throttledScroll', function (evt) {
                ...
                if (!timer) {
                    timer = setTimeout(function () {
                        ...
                        $(_this).triggerHandler('throttledScroll'); //this需要穿透
                ...
                if (!timer) {
                    ...
                    timer = setTimeout(function () {
                        if (click_count >= 3) {
                            ...
                            $(_this).triggerHandler('tripleclick1', click_count);
                            click_count = 0;
                        }
                        timer = 0;
    ...
    $.event.special.tripleclick2 = {
        setup: function () {
            ...
            jlistener.data('timer', setInterval(function () {
    ...
    $.event.special.mousemovehalt = {
        ...
        setup: function (options, namespace) {
            ...
            $(this).on('mousemove.mousemovehalt', function (evt) {
                ...
                timer = setTimeout(function () {
                    $(_this).triggerHandler('mousemovehalt'); //this需要穿透
                    timer = 0;
                }, opt.delay);
            });
        },
