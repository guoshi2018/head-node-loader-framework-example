...
(function ($) {
    ...
    $.fn.exam2 = function (s) {
        alert("hello,this is jquery method - example two:".concat(s));
        return this;
    };
    ...
    $.fn.shadow3 = function (options) {
        var opt = $.extend({}, $.fn.shadow3.defaults, options);
        return this.each(function () {
            var jele = $(this);
            for (var i = 0; i < (opt.copies || 0); i++) {
                var ele_off = jele.offset() || {
                    left: 0,
                    top: 0
                };
                var off = opt.copyOffset ? opt.copyOffset(i) : {
                    left: i,
                    top: i
                };
                jele.clone()
